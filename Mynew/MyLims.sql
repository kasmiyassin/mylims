...
BEGIN
    ...
    ELSE
        id_prefix := sample_type_abrv || sampling_year || '--';
    END IF;
...
GROUP BY
    ...
    stat.description, e.experiment_date, pers.full_name
...
INSERT INTO "reference"."samples_type" ("sample_type_id", "sample_type_abrv", "description") VALUES
